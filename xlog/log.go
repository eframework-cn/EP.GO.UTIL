...
func (this *logMsg) toString(prefix string) string {
	msg := this.fmt
	if len(this.args) > 0 {
		msg = fmt.Sprintf(this.fmt, this.args...)
	}
	msg = prefix + " " + msg
	msg = levelPrefix[this.level] + " " + msg
	return msg
}
...
func (bl *BeeLogger) startLogger() {
	...
	for {
		select {
		case bm := <-bl.msgChan:
			bl.writeToLoggers(bm.when, bm.toString(bl.prefix), bm.level)
			logMsgPool.Put(bm)
...
func Emergency(f interface{}, v ...interface{}) {
	beeLogger.Emergency(Format(f, v...))
}

// Alert logs a message at alert level.
func Alert(f interface{}, v ...interface{}) {
	beeLogger.Alert(Format(f, v...))
}

// Critical logs a message at critical level.
func Critical(f interface{}, v ...interface{}) {
	beeLogger.Critical(Format(f, v...))
}

// Error logs a message at error level.
func Error(f interface{}, v ...interface{}) {
	beeLogger.Error(Format(f, v...))
}

// Warning logs a message at warning level.
func Warning(f interface{}, v ...interface{}) {
	beeLogger.Warn(Format(f, v...))
}
...
func Notice(f interface{}, v ...interface{}) {
	beeLogger.Notice(Format(f, v...))
}

// Informational logs a message at info level.
func Informational(f interface{}, v ...interface{}) {
	beeLogger.Info(Format(f, v...))
}
...
func Debug(f interface{}, v ...interface{}) {
	beeLogger.Debug(Format(f, v...))
}

// Trace logs a message at trace level.
// compatibility alias for Warning()
func Trace(f interface{}, v ...interface{}) {
	beeLogger.Trace(Format(f, v...))
}
